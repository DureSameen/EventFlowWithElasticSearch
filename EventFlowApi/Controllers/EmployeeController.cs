...
namespace EventFlowApi.Controllers
{
    ...
    public class EmployeeController : BaseController
    {
        ...
        //               new ReadModelByIdQuery<EmployeeReadModel>(employeeId), CancellationToken.None)
        ...
        //    var response = new EmployeeResponse { Id = readModel.Id, FirstName = readModel.FirstName, LastName = readModel.LastName, Transactions= transactions };
        //    return response;
        //}
        /// <summary>
